...
INSERT INTO "pvms_user" ("id","name","password","email","location","skillset","causes","type","adminAccess","profile") VALUES ('12','Deepak','$2a$13$TDoAQfWsoD.9t54gTysg7efNlO4.8P07GDewLiigpjWG16Y9.XOt2','dazad@gmail.com','Vancouver','Education',NULL,'2','0',NULL);
...
INSERT INTO "pvms_user" ("id","name","password","email","location","skillset","causes","type","adminAccess","profile") VALUES ('15','Harry','$2a$12$L7Bt02zTY.35HCHODI3IDecUTLWG.iEEC1njyIBqJf/ZJXPgbbMmC','harry@rec.ubc.ca','Vancouver','School',NULL,'2','0',NULL);
INSERT INTO "pvms_user" ("id","name","password","email","location","skillset","causes","type","adminAccess","profile") VALUES ('16','Billy','$2a$12$L7Bt02zTY.35HCHODI3IDecUTLWG.iEEC1njyIBqJf/ZJXPgbbMmC','billy@rec.ubc.ca','Vancouver','School',NULL,'2','0',NULL);
INSERT INTO "pvms_user" ("id","name","password","email","location","skillset","causes","type","adminAccess","profile") VALUES ('17','Rex','$2a$12$L7Bt02zTY.35HCHODI3IDecUTLWG.iEEC1njyIBqJf/ZJXPgbbMmC','rex@rec.ubc.ca','Vancouver','School',NULL,'2','0',NULL);
INSERT INTO "pvms_user" ("id","name","password","email","location","skillset","causes","type","adminAccess","profile") VALUES ('18','Joel','$2a$12$L7Bt02zTY.35HCHODI3IDecUTLWG.iEEC1njyIBqJf/ZJXPgbbMmC','joel@rec.ubc.ca','Vancouver','School',NULL,'2','0',NULL);
INSERT INTO "pvms_user" ("id","name","password","email","location","skillset","causes","type","adminAccess","profile") VALUES ('19','Melissa','$2a$12$L7Bt02zTY.35HCHODI3IDecUTLWG.iEEC1njyIBqJf/ZJXPgbbMmC','melissa@rec.ubc.ca','Vancouver','School',NULL,'2','0',NULL);
INSERT INTO "pvms_user" ("id","name","password","email","location","skillset","causes","type","adminAccess","profile") VALUES ('20','Gord','$2a$12$L7Bt02zTY.35HCHODI3IDecUTLWG.iEEC1njyIBqJf/ZJXPgbbMmC','gord@rec.ubc.ca','Vancouver','School',NULL,'2','0',NULL);
INSERT INTO "pvms_user" ("id","name","password","email","location","skillset","causes","type","adminAccess","profile") VALUES ('21','Lucas','$2a$12$L7Bt02zTY.35HCHODI3IDecUTLWG.iEEC1njyIBqJf/ZJXPgbbMmC','lucas@rec.ubc.ca','Vancouver','School',NULL,'2','0',NULL);
INSERT INTO "pvms_user" ("id","name","password","email","location","skillset","causes","type","adminAccess","profile") VALUES ('22','Emma','$2a$12$L7Bt02zTY.35HCHODI3IDecUTLWG.iEEC1njyIBqJf/ZJXPgbbMmC','emma@rec.ubc.ca','Vancouver','School',NULL,'2','0',NULL);
INSERT INTO "pvms_user" ("id","name","password","email","location","skillset","causes","type","adminAccess","profile") VALUES ('23','Olivia','$2a$12$L7Bt02zTY.35HCHODI3IDecUTLWG.iEEC1njyIBqJf/ZJXPgbbMmC','olivia@rec.ubc.ca','Vancouver','School',NULL,'2','0',NULL);
-- Volunteers end
